...
export default function Page() {
  ...
  {/* Main Content */}
  <div className="z-10 text-center mt-28">
    <p className="text-4xl sm:text-7xl font-bold text-gray-700">
    Elevate Your Skills <br></br> with <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-yellow-300">Mockskills</span> 
    </p>
